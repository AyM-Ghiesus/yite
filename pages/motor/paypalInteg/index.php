...
<body>
    <div class="container">
        <h1>PayPal</h1>
        <div class="panel">
    <div class="overlay hidden"><div class="overlay-content"><img src="./sample.gif" alt="Processing..."/></div></div>

    <div class="panel-heading">
        <h3 class="panel-title">Charge <?php echo '₱  '.$itemPrice; ?> with PayPal</h3>
        
        <!-- Product Info -->
        <p><b>Total Products:</b> <?php echo $itemName; ?></p>
...
paypal.Buttons({
    ...
    onApprove: (data, actions) => {
        return actions.order.capture().then(function(orderData) {
            ...
            fetch('paypal_checkout_validate.php?orderid=<?php echo $orderId ?>', {
                method: 'POST',
            ...
            .then((result) => {
                if(result.status == 1){
                    window.location.href = "payment-status.php?orderid=<?php echo $orderId ?>&checkout_ref_id="+result.ref_id;
                }else{
