...
<?php if(!empty($payment_ref_id)){ ?>
    ...
    <p><b>Paid Amount:</b> <?php echo number_format($paid_amount).' '.$paid_amount_currency; ?></p>
    ...
    <p><b>Products Bought:</b> <?php echo $itemName; ?></p>
    <p><b>Price:</b> <?php echo number_format($itemPrice).' '.$currency; ?></p>
<?php }else{ ?>
    <h1 class="error">Your Payment been failed!</h1>
    <p class="error"><?php echo $statusMsg; ?></p>
<?php }?>
<a href="../shopProfile.php"><button>Go Back To Your Profile</button></a><br><br>
<a href="../homeProducts.php"><button>Go Back To Shopping</button></a>