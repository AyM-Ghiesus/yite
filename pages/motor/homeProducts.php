    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" action="../motor/search_homeProdcuts.php" method="GET">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            if(isset($_GET['brand']) && $_GET['brand'] == $b_id){
              $sel_brand="SELECT * FROM brand";
              $res_brand=mysqli_query($conn,$sel_brand);
            ...
            elseif (isset($_GET['category']) && $_GET['category'] == $c_id) {
              echo "<h1>$c_name</h1>";
            }
