  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../pages/motor/homeProducts.php" class="brand-link">
      <img src="../../dist/img/MotorLogo.png"
           alt="MotorLogo.png" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./viewProducts.php" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./viewBrands&Cat.php" class="nav-link">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All your products are here. </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example2" class="table table-bordered  text-center">
                  ...
                  <tbody>
                      ...
                      $resProd=mysqli_query($conn,$getProd);
                      $number = 1;
                      while ($row=mysqli_fetch_assoc($resProd)) {
                       ...
                       <td><img src='../layout/productImages/<?php echo $productImg?>' class="cartImg"></td>
                       ...
                       <td>
                        ...
                        $resCount=mysqli_query($conn,$getCount);
                       ...
                       <td>
                           <a href="./editproduct.php?editproduct=<?php echo $productId?>" class='btn btn-info btn-sm btn-edit'>
                                 <i class='fas fa-pencil-alt'></i>
                                 Edit
                             </a>
                             <a href="./deleteproduct.php?deleteproduct=<?php echo $productId?>" class='btn btn-danger btn-sm btn-delete'>
