    ...
    <div class="card-body register-card-body">
      ...
      <!-- PRODUCT NAME -->
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Update Product Name" value="<?php echo $brandtitle?>" autocomplete="off" required="required" name="brandd">
        ...
        <div class="row">
          ...
          <!-- /.col -->
            ...
            <button type="submit" class="btn btn-danger btn-block" name="updatebrand">Delete Brand</button>
...
<?php 
    if (isset($_POST['updatebrand'])) {
       ...
       $delete="DELETE FROM brand WHERE brand_id='$editbrand'";
